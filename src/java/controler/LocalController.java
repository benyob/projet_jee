...
public class LocalController implements Serializable {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("LocalUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("LocalDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Local getLocal(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<Local> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Local> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class LocalControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Local) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Local.class.getName()});
                return null;
            }
        }
